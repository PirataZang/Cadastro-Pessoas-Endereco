...
export namespace Prisma {
  ...
  */
  ...
  export type PessoaCountOutputTypeSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    Endereco?: boolean | PessoaCountOutputTypeCountEnderecoArgs
  }
   ...
   * PessoaCountOutputType without action
   */
  export type PessoaCountOutputTypeCountEnderecoArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
  ...
  export type PessoaCountAggregateOutputType = {
    ...
    pes_nome: number
    pes_sexo: number
    pes_estado_civil: number
    pes_data_nascimento: number
    _all: number
  }
  ...
  export type PessoaMinAggregateInputType = {
    ...
    pes_nome?: true
    pes_sexo?: true
    pes_estado_civil?: true
    pes_data_nascimento?: true
  }
  ...
  export type PessoaSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    pes_nome?: boolean
    pes_sexo?: boolean
    pes_estado_civil?: boolean
    pes_data_nascimento?: boolean
  ...
  export interface PessoaDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * 
     * // Only select the `pes_id`
     * const pessoaWithPes_idOnly = await prisma.pessoa.findMany({ select: { pes_id: true } })
     * 
    **/
  ...
  export interface Prisma__PessoaClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    ...
    Endereco<T extends Pessoa$EnderecoArgs<ExtArgs> = {}>(args?: Subset<T, Pessoa$EnderecoArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$EnderecoPayload<ExtArgs>, T, 'findMany'> | Null>;
  ...
  interface PessoaFieldRefs {
    readonly pes_id: FieldRef<"Pessoa", 'Int'>
    readonly pes_nome: FieldRef<"Pessoa", 'String'>
    readonly pes_sexo: FieldRef<"Pessoa", 'String'>
    readonly pes_estado_civil: FieldRef<"Pessoa", 'String'>
    readonly pes_data_nascimento: FieldRef<"Pessoa", 'String'>
  }
  ...
  export interface EnderecoDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * 
     * // Only select the `end_id`
     * const enderecoWithEnd_idOnly = await prisma.endereco.findMany({ select: { end_id: true } })
     * 
    **/
  ...
  interface EnderecoFieldRefs {
    readonly end_id: FieldRef<"Endereco", 'Int'>
    readonly end_rua: FieldRef<"Endereco", 'String'>
    readonly end_bairro: FieldRef<"Endereco", 'String'>
    readonly end_cidade: FieldRef<"Endereco", 'String'>
    readonly end_numero: FieldRef<"Endereco", 'Int'>
    readonly pes_id: FieldRef<"Endereco", 'Int'>
  }
  ...
  export type PessoaWhereInput = {
    ...
    pes_id?: IntFilter<"Pessoa"> | number
    pes_nome?: StringFilter<"Pessoa"> | string
    pes_sexo?: StringFilter<"Pessoa"> | string
    pes_estado_civil?: StringFilter<"Pessoa"> | string
    pes_data_nascimento?: StringFilter<"Pessoa"> | string
  ...
  export type PessoaOrderByWithRelationInput = {
    ...
    pes_nome?: SortOrder
    pes_sexo?: SortOrder
    pes_estado_civil?: SortOrder
    pes_data_nascimento?: SortOrder
  ...
  export type PessoaScalarWhereWithAggregatesInput = {
    ...
    pes_id?: IntWithAggregatesFilter<"Pessoa"> | number
    pes_nome?: StringWithAggregatesFilter<"Pessoa"> | string
    pes_sexo?: StringWithAggregatesFilter<"Pessoa"> | string
    pes_estado_civil?: StringWithAggregatesFilter<"Pessoa"> | string
    pes_data_nascimento?: StringWithAggregatesFilter<"Pessoa"> | string
  }
  ...
  export type EnderecoWhereInput = {
    ...
    end_id?: IntFilter<"Endereco"> | number
    end_rua?: StringFilter<"Endereco"> | string
    end_bairro?: StringFilter<"Endereco"> | string
    end_cidade?: StringFilter<"Endereco"> | string
    end_numero?: IntFilter<"Endereco"> | number
    pes_id?: IntFilter<"Endereco"> | number
  ...
  export type EnderecoOrderByWithRelationInput = {
    end_id?: SortOrder
    end_rua?: SortOrder
    end_bairro?: SortOrder
    end_cidade?: SortOrder
    end_numero?: SortOrder
    pes_id?: SortOrder
  ...
  export type EnderecoScalarWhereWithAggregatesInput = {
    ...
    end_id?: IntWithAggregatesFilter<"Endereco"> | number
    end_rua?: StringWithAggregatesFilter<"Endereco"> | string
    end_bairro?: StringWithAggregatesFilter<"Endereco"> | string
    end_cidade?: StringWithAggregatesFilter<"Endereco"> | string
    end_numero?: IntWithAggregatesFilter<"Endereco"> | number
    pes_id?: IntWithAggregatesFilter<"Endereco"> | number
  }
  ...
  export type PessoaUpdateInput = {
    pes_nome?: StringFieldUpdateOperationsInput | string
    pes_sexo?: StringFieldUpdateOperationsInput | string
    pes_estado_civil?: StringFieldUpdateOperationsInput | string
    pes_data_nascimento?: StringFieldUpdateOperationsInput | string
    Endereco?: EnderecoUpdateManyWithoutPessoaNestedInput
  }

  export type PessoaUncheckedUpdateInput = {
    pes_id?: IntFieldUpdateOperationsInput | number
    pes_nome?: StringFieldUpdateOperationsInput | string
    pes_sexo?: StringFieldUpdateOperationsInput | string
    pes_estado_civil?: StringFieldUpdateOperationsInput | string
    pes_data_nascimento?: StringFieldUpdateOperationsInput | string
  ...
  export type EnderecoUpdateInput = {
    end_rua?: StringFieldUpdateOperationsInput | string
    end_bairro?: StringFieldUpdateOperationsInput | string
    end_cidade?: StringFieldUpdateOperationsInput | string
    end_numero?: IntFieldUpdateOperationsInput | number
  ...
  export type EnderecoCreateNestedManyWithoutPessoaInput = {
    create?: XOR<EnderecoCreateWithoutPessoaInput, EnderecoUncheckedCreateWithoutPessoaInput> | EnderecoCreateWithoutPessoaInput[] | EnderecoUncheckedCreateWithoutPessoaInput[]
    connectOrCreate?: EnderecoCreateOrConnectWithoutPessoaInput | EnderecoCreateOrConnectWithoutPessoaInput[]
  ...
  export type EnderecoUpdateManyWithoutPessoaNestedInput = {
    create?: XOR<EnderecoCreateWithoutPessoaInput, EnderecoUncheckedCreateWithoutPessoaInput> | EnderecoCreateWithoutPessoaInput[] | EnderecoUncheckedCreateWithoutPessoaInput[]
    connectOrCreate?: EnderecoCreateOrConnectWithoutPessoaInput | EnderecoCreateOrConnectWithoutPessoaInput[]
    upsert?: EnderecoUpsertWithWhereUniqueWithoutPessoaInput | EnderecoUpsertWithWhereUniqueWithoutPessoaInput[]
    ...
    connect?: EnderecoWhereUniqueInput | EnderecoWhereUniqueInput[]
    update?: EnderecoUpdateWithWhereUniqueWithoutPessoaInput | EnderecoUpdateWithWhereUniqueWithoutPessoaInput[]
    updateMany?: EnderecoUpdateManyWithWhereWithoutPessoaInput | EnderecoUpdateManyWithWhereWithoutPessoaInput[]
  ...
  export type PessoaUpdateOneRequiredWithoutEnderecoNestedInput = {
    ...
    connect?: PessoaWhereUniqueInput
    update?: XOR<XOR<PessoaUpdateToOneWithWhereWithoutEnderecoInput, PessoaUpdateWithoutEnderecoInput>, PessoaUncheckedUpdateWithoutEnderecoInput>
  }
  ...
  export type EnderecoUpdateManyWithWhereWithoutPessoaInput = {
    ...
    data: XOR<EnderecoUpdateManyMutationInput, EnderecoUncheckedUpdateManyWithoutPessoaInput>
  }
  ...
  export type EnderecoUncheckedUpdateManyWithoutPessoaInput = {
    end_id?: IntFieldUpdateOperationsInput | number
    end_rua?: StringFieldUpdateOperationsInput | string
    end_bairro?: StringFieldUpdateOperationsInput | string
    end_cidade?: StringFieldUpdateOperationsInput | string
